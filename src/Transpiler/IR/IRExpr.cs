...
public sealed record IRDictionaryCount(IRExpr Table) : IRExpr;
public sealed record IRDictionaryGet(IRExpr Table, IRExpr Key) : IRExpr;
public sealed record IRDictionaryAdd(IRExpr Table, IRExpr Key, IRExpr Value) : IRExpr;
...
public sealed record IRDictionaryContainsKey(IRExpr Table, IRExpr Key) : IRExpr;
public sealed record IRDictionaryClear(IRExpr Table) : IRExpr;
public sealed record IRDictionaryKeys(IRExpr Table) : IRExpr;
public sealed record IRDictionaryValues(IRExpr Table) : IRExpr;
...
public sealed record IRListContains(IRExpr List, IRExpr Value) : IRExpr;
public sealed record IRListIndexOf(IRExpr List, IRExpr Value) : IRExpr;
public sealed record IRListInsert(IRExpr List, IRExpr Index, IRExpr Value) : IRExpr;
public sealed record IRListRemove(IRExpr List, IRExpr Value) : IRExpr;
