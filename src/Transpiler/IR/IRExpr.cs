...
public sealed record IRQueueDequeue(IRExpr Queue) : IRExpr;
public sealed record IRQueuePeek(IRExpr Queue) : IRExpr;
public sealed record IRStackPop(IRExpr Stack) : IRExpr;
public sealed record IRStackPeek(IRExpr Stack) : IRExpr;
public sealed record IRStackToArray(IRExpr Stack) : IRExpr;
public sealed record IRHashSetNew(bool UseLinearKeys = false, IRExpr? KeyComparer = null) : IRExpr;
public sealed record IRHashSetCount(IRExpr Set, bool UseLinearKeys = false) : IRExpr;
public sealed record IRHashSetAdd(IRExpr Set, IRExpr Value, bool UseLinearKeys = false) : IRExpr;
public sealed record IRHashSetRemove(IRExpr Set, IRExpr Value, bool UseLinearKeys = false) : IRExpr;
public sealed record IRHashSetContains(IRExpr Set, IRExpr Value, bool UseLinearKeys = false) : IRExpr;
public sealed record IRHashSetClear(IRExpr Set, bool UseLinearKeys = false) : IRExpr;
public sealed record IRHashSetToArray(IRExpr Set, bool UseLinearKeys = false) : IRExpr;
